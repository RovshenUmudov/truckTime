  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent '
        + 'px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-destructive-foreground '
        ...
        + 'group-[.destructive]:focus:ring-destructive bg-destructive border-destructive text-white',
      className,
    )}
    {...props}
  />
